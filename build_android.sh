...
#!/usr/bin/env bash
# =============================================================================
#  build_android.sh — Cross-compile AoSChat for Android via NDK + CMake
# =============================================================================
#
#  USAGE:
...
FINAL_BUILD="$BUILD_ROOT/AoSChat-${ABI}"
...
sed -i.bak 's|mkdir("/sdcard/AoSChat");|mkdir("/sdcard/AoSChat", 0755);|' "$PROJECT_DIR/src/main.c"
...
ok "============================================================"
ok " Build complete!"
ok " Output binary: $FINAL_BUILD/AoSChat/client"
ok "============================================================"
echo
