...
# -------------------------
# Assembles the AoSChat game assets into the Android Studio project's
...
#
# Usage:
#   ./package_android_assets.sh [AOSCHAT_DIR] [ANDROID_PROJECT_DIR]
#
# With no arguments it assumes it lives in the AoSChat repo root and the
